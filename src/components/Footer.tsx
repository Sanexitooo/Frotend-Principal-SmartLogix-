    ...
    <footer className="bg-saas-black border-t border-gray-800 pt-16 pb-8 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* Info de la Empresa y Dirección Sede */}
          <div className="col-span-1 md:col-span-1">
            ...
            {/* UBICACIÓN SOLICITADA - ANTONIO VARAS 666 */}
            <div className="bg-white/5 p-4 rounded-xl border border-white/10 mb-6">
              <p className="text-saas-orange font-bold text-xs uppercase tracking-widest mb-1">Ubicación Central</p>
          ...
          {/* Links de Producto - Actualizados para que coincidan con Navbar */}
          <div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          ...
          <p className="text-gray-400 font-medium text-sm">
            Página creada por estudiantes de <span className="text-white font-bold">Duoc UC - Sede Antonio Varas</span>
          </p>
        </div>
      </div>
    </footer>
