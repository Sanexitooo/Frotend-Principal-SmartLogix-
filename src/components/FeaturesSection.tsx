...
const FeatureCard = ({ feature, index }: { feature: Feature; index: number }) => {
  ...
  return (
    <motion.div {...anim} className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100 hover:border-saas-orange/40 hover:bg-white hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 group">
