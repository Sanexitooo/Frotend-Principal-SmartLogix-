...
const HeroSection = () => {
  return (
    <div className="relative bg-saas-white overflow-hidden min-h-[90vh] flex items-center pt-20">
      {/* Decoración de fondo */}
        ...
        <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
          <div className="animate-fade-in">
            ...
            <p className="text-lg md:text-xl mb-8 text-slate-600 max-w-2xl mx-auto">
              Optimiza tus operaciones, aumenta la productividad y mejora la satisfacción de tus clientes con nuestra plataforma logística de última generación.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              {/* CORRECCIÓN: Botón con fondo blanco forzado para evitar el bloque negro */}
              <Button 
                variant="ghost" 
            ...
            {/* Imágenes de confianza (Users y Pug) */}
            <div className="mt-12 flex items-center justify-center gap-4">
              <div className="flex -space-x-3">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT9U1CvvldfhYbQ1oWOFEosFwh8xpG3ft4ZJw&s" 
                  className="w-12 h-12 rounded-full border-4 border-white shadow-sm object-cover" alt="User 1" />
                <img src="https://img.lahora.cl/upload/2026/02/17161D524C43466D15100F55504940791F121D18534146731514-1200x800.webp" 
                  className="w-12 h-12 rounded-full border-4 border-white shadow-sm object-cover" alt="User 2" />
                <img src="https://media-front.elmostrador.cl/2022/05/124820758_pug1-210x210.jpg" 
                  className="w-12 h-12 rounded-full border-4 border-white shadow-sm object-cover" alt="User 3 (Pug)" />
              </div>
              <p className="text-sm text-slate-500 font-medium">
                Más de <span className="font-bold text-saas-teal">500+</span> empresas confían en nosotros
              </p>
            </div>
          </div>
          ...
          <div className="mt-20 animate-fade-in" style={{animationDelay: '0.3s'}}>
            <div className="relative max-w-5xl mx-auto px-4">
              <div className="relative bg-white rounded-2xl border border-slate-200 p-2 shadow-2xl">
                <img 
                  src="https://images.unsplash.com/photo-1668597388138-9d1dae099182?q=80&w=1078&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
